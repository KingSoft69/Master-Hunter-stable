...
import static dev.masterhunter.addon.util.Utils.positionInDirection;
import static dev.masterhunter.addon.util.Utils.sendWebhook;
...
public class TrailFollower extends Module
{
    ...
    {
        super(Main.CATEGORY, "TrailFollower", "Automatically follows trails in all dimensions.");
    }
...
//                log("ChunkPos: " + chunkPos.x + ", " + chunkPos.z);
        ...
        // Count chunks for speed monitoring (count all chunk loads, not just valid trail chunks)
        if (autoDisconnectOnSpeed.get()) {
    ...
    private void log(String message)
    {
        ...
        {
            sendWebhook(webhookLink.get(), "TrailFollower", message, null, null);
        }
    }
