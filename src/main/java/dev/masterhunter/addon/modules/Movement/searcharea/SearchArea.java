package dev.masterhunter.addon.modules.Movement.searcharea;

import meteordevelopment.meteorclient.events.world.TickEvent;
import dev.masterhunter.addon.Main;
import dev.masterhunter.addon.modules.Movement.searcharea.modes.Rectangle;
import dev.masterhunter.addon.modules.Movement.searcharea.modes.Spiral;
import dev.masterhunter.addon.modules.Movement.searcharea.modes.DynamicSpiral;
...
public class SearchArea extends Module {
    ...
    public SearchArea() {
        super(Main.CATEGORY, "search-area", "Either loads chunks in a rectangle to a certain point from you, or spirals endlessly from you. Useful with StashFinderPlus or other map saving mods.");
    }
    ...
    private void onModeChanged(SearchAreaModes mode) {
        switch (mode) {
            ...
            case DynamicSpiral -> currentMode = new DynamicSpiral();
        }
    }
